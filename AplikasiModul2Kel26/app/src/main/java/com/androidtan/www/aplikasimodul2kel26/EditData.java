package com.androidtan.www.aplikasimodul2kel26;
...
public class EditData extends AppCompatActivity {
    ...
    private Button btnUpdate, btnDelete, btnlistData;
    ...
    private void listData() {
        btnlistData.setOnClickListener(V -> {
            Intent reg = new Intent(this, ViewDataActivity.class);
            startActivity(reg);
            finish();}
        );
    }
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        deletePreference();
                        Intent login = new Intent(EditData.this, LoginActivity.class);
                        startActivity(login);
                        cek.deleteModel(usr);
                        finish();
                    }
